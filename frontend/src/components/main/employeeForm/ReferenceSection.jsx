...
const ReferenceSection = ({
    ...
    const handleSaveReference = async (index) => {
        ...
        try {
            ...
            if (reference.id) {
                ...
                res = await saveReference(employee.employee.id, payload);
            }
    ...
    const confirmDelete = async () => {
        ...
        try {
            await deleteReference(employee.employee.id, reference.id);
            ...
            <div className="flex flex-col h-full">
                <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <Button type="button" size="small" onClick={handleAddReference}>
                            + Add Reference
                        </Button>
                    </div>
                    ...
                    {fields.length === 0 && (
                        <p className="text-sm text-muted">
                            No references added yet. Click + Add Reference to create one.
                        </p>
                    )}
