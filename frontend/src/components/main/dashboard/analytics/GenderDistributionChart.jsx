...
export const GenderDistributionChart = ({ summary }) => {
    ...
    const genderData = [
        {
            name: "Male",
            value: Number(summary.total_male) || 0,
            fill: "#6366f1"
        },
        {
            name: "Female",
            value: Number(summary.total_female) || 0,
            fill: "#ec4899"
        }
    ];

    const totalEmployees = genderData.reduce(
